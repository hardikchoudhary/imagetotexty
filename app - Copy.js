...
server.post('http://localhost:3978/api/messages', connector.listen());
...
var bot = new builder.UniversalBot(connector, function (session) {
    ...
    var messageTiming = session.message.localTimestamp;
    var greeting = "";
...
geocoder.geocode(nearfromPlace, function(err, res) {
		console.log(res[0].latitude+"L"+res[0].longitude);
